...
const images = [
  // Front
  { position: [0, -0.5, 1.5], rotation: [0, 0, 0], url: pexel(1103970), url: "https://cdn.shopify.com/s/files/1/2469/4477/products/the-mountain-1_540x.jpg?v=1541006626"},
  // Back
  { position: [-0.8, -0.5, -0.6], rotation: [0, 0, 0], url: pexel(416430), url: "https://cdn.shopify.com/s/files/1/2469/4477/products/vinterns-magi-1_540x.jpg?v=1568752238" },
  { position: [0.8, -0.5, -0.6], rotation: [0, 0, 0], url: pexel(310452), url: "https://cdn.shopify.com/s/files/1/2469/4477/products/dalahast-if-1_540x.jpg?v=1564661546" },
  // Left
  {
